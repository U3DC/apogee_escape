...
public class SpawnManager : MonoBehaviour
{
    ...
    {
        Transform newAlien = Instantiate(_enemy, furthestSpawnPoint.position + new Vector3(Random.insideUnitSphere.x * spawnPointRandomRadius, Random.insideUnitSphere.y * spawnPointRandomRadius, 0), furthestSpawnPoint.rotation) as Transform; 
        newAlien.GetComponent<AIDestinationSetter>().target = GameObject.FindWithTag("Player").transform; 
