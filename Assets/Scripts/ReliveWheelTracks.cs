...
public class ReliveWheelTracks : MonoBehaviour {
    public  BoxCollider correspondingCollider;
	...
	void Update () 
    {
        ...
        //set up array 
        //raycast from wheel
        //add to array every seconds
        //send array to trail renderer
...
//        Vector3 ColliderCenterPoint = correspondingCollider.transform.TransformPoint(correspondingCollider.transform.position);
//
...
//
//
//        if (Physics.Raycast(ColliderCenterPoint, Vector3.down, out hit, Mathf.Infinity))
//        {
...
//        {
//            tracksPrefab.gameObject.active = true;
//        }
//        else if ( Mathf.Abs( CorrespondingGroundHit.sidewaysSlip ) <= .75 )
//        {
//            tracksPrefab.gameObject.active = false;
//        }
//	}
//}
//
