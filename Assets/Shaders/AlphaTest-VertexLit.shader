...
Properties {
    ...
    _ShakeDisplacement ("Displacement", Range (0, 1.0)) = 0.2
    _ShakeTime ("Shake Time", Range (0, 1.0)) = 0.2
    _ShakeWindspeed ("Shake Windspeed", Range (0, 1.0)) = 0.1
    _ShakeBending ("Shake Bending", Range (0, 1.0)) = 0.1
...
#pragma surface surf Lambert alphatest:_Cutoff vertex:vert nolightmap noforwardadd fullforwardshadows //addshadow 
